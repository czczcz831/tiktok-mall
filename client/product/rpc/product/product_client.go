...
func (c *clientImpl) ChargeStock(ctx context.Context, req *product.ChargeStockReq, callOptions ...callopt.Option) (r *product.ChargeStockResp, err error) {
	return c.kitexClient.ChargeStock(ctx, req, callOptions...)
}
