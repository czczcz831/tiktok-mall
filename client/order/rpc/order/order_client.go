...
func (c *clientImpl) GetUserOrders(ctx context.Context, req *order.GetUserOrdersReq, callOptions ...callopt.Option) (r *order.GetUserOrdersResp, err error) {
	return c.kitexClient.GetUserOrders(ctx, req, callOptions...)
}
