...
func (p *RegisterResp) SetUserUuid(val string) {
	p.UserUuid = val
}
...
func (p *LoginResp) GetUserUuid() (v string) {
	return p.UserUuid
}
func (p *LoginResp) SetUserUuid(val string) {
	p.UserUuid = val
}
...
func (p *GetUserInfoReq) GetUserUuid() (v string) {
	return p.UserUuid
}
func (p *GetUserInfoReq) SetUserUuid(val string) {
	p.UserUuid = val
}
